...
import developer from "../../images/developerdesign.svg"
import responsive from "../../images/responsivedesign.svg"
import idea from "../../images/innovativesolutions.svg"
					...
					<div className = "development-summary">
						<div className = "col-sm-1 col-md-1">
							<div className = "development-img">
								<img alt="" className = "img-responsive" src ={developer}/>
							</div>
						</div>
					...
					<div className = "responsive-summary">
						<div className = "col-sm-1 col-md-1 col-sm-offset-2 col-md-offset-2">
							<div className = "responsive-img">
								<img alt="" className = "img-responsive" src = {responsive} />
							</div>
						</div>
					...
					<div className = "ideas-summary">
						<div className = "col-sm-1 col-md-1">
							<div className = "idea-img">
								<img alt="" className = "img-responsive" src ={idea} />
							</div>
						</div>
